...
namespace Drupal\editvr_sample_content\Plugin\migrate\source;
...
class CSV extends SourcePluginBase {
  ...
  public function __construct(array $configuration, $plugin_id, $plugin_definition, MigrationInterface $migration) {
    ...
    $this->fileClass = empty($configuration['file_class']) ? '\Drupal\editvr_sample_content\CSVFileObject' : $configuration['file_class'];
  }
